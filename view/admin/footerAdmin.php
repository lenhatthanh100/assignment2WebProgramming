	...
	<div class="container-fluid mt-5 bg-secondary px-3 py-3">
		<div class="row">
			...
			<div class="col-md-4">
				<ul>
					<li>
						<a href="manageAccountView.php"><p class="text-dark">Quản lý tài khoản</p></a>
					</li>
					<li>
						<a href="createAccountForStaffView.php"><p class="text-dark">Tạo tài khoản cho nhân viên</p></a>
					</li>
                    <li>
