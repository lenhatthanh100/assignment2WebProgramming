	...
	<div class="container-fluid mt-5 bg-secondary px-3 py-3">
		<div class="row">
			<div class="col-md-3">
				...
				<p>© Bản quyền Vingroup 2020</p>
			</div>
			<div class="col-md-5">
				<p class="font-weight-bold">Kết nối với chúng tôi</p>
				<ul>
					<li>
						<p>Địa chỉ:Số 7 Đường Bằng Lăng 2, Phường Việt Hưng, Quận Long Biên, Phú Yên</p>
					</li>
					<li>
			...
			<div class="col-md-4">
				<ul>
					...
					<li>
						<a href="newsView.php"><p class="text-dark">Tin tức, sự kiện</p></a>
					</li>
					<li>
						<a href="serviceView.php"><p class="text-dark">Dịch vụ, sản phẩm</p></a>
					</li>
					<li>
